...
pub mod database_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn status(
            ...
            let path = http::uri::PathAndQuery::from_static("/edb.Database/Status");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("edb.Database", "Status"));
...
pub mod database_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/edb.Database/Status" => {
                    ...
                    struct StatusSvc<T: Database>(pub Arc<T>);
                    impl<T: Database> tonic::server::UnaryService<super::StatusRequest>
                    for StatusSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Database>::status(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T: Database> tonic::server::NamedService for DatabaseServer<T> {
        const NAME: &'static str = "edb.Database";
    }
}
